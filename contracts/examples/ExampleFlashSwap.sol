...
contract ExampleFlashSwap is IUniswapV2Callee {
    ...
    constructor(address _factory, address _factoryV1, address router) public {
        ...
        factory = _factory;
        WBNB = IWBNB(IPepeRouter01(router).WBNB());
    }

    // needs to accept BNBBNB from any V1 exchange and WBNB. ideally this could be enforced, as in the router,
    ...
    function uniswapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external override {
        ...
        assert(msg.sender == PepeLibrary.pairFor(factory, token0, token1)); // ensure that msg.sender is actually a V2 pair
        ...
        if (amountToken > 0) {
            ...
            uint amountRequired = PepeLibrary.getAmountsIn(factory, amountToken, path)[0];
            ...
            uint amountRequired = PepeLibrary.getAmountsIn(factory, amountBNB, path)[0];
